	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租金" prop="zujin">
					<el-input v-model="ruleForm.zujin" placeholder="租金" clearable  :readonly="ro.zujin"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="租金" prop="zujin">
					<el-input v-model="ruleForm.zujin" placeholder="租金" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租赁天数" prop="zulintianshu">
					<el-input v-model="ruleForm.zulintianshu" placeholder="租赁天数" clearable  :readonly="ro.zulintianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="租赁天数" prop="zulintianshu">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="应还日期" prop="yinghairiqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yinghairiqi" label="应还日期" prop="yinghairiqi">
					<el-input v-model="ruleForm.yinghairiqi" placeholder="应还日期" readonly></el-input>
				</el-form-item>
...
export default {
	...
	computed: {
		...
		zongjia:{
			get: function () {
				return 1*this.ruleForm.zujin*this.ruleForm.zulintianshu
			}
		},
	...
	created() {
		...
		this.ruleForm.yinghairiqi = this.getCurDate()
	},
	methods: {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springcloudzaxzu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
