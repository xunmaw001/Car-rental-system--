			...
			<el-form class="center-form-pv" :style='{"margin":"0 0 30px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","borderRadius":"3px","background":"#fff","display":"block"}' >
					...
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}' class="select" label="品牌" prop="pinpai">
						...
						<el-select  @change="pinpaiChange" clearable v-model="searchForm.pinpai" placeholder="请选择品牌">
							<el-option v-for="(item,index) in pinpaiOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">汽车类型</label>
						<el-input v-model="searchForm.qicheleixing" placeholder="汽车类型" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}' class="select" label="颜色" prop="yanse">
						...
						<el-select  @change="yanseChange" clearable v-model="searchForm.yanse" placeholder="请选择颜色">
							<el-option v-for="(item,index) in yanseOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button :style='{"border":"1px solid #3ca512","cursor":"pointer","padding":"0 10px 0 24px","margin":"3px 6px 3px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"url(http://codegen.caihongy.cn/20221011/ca1c191554d24b108bc94f4a2046d636.png) #41b314 no-repeat 5px 8px","width":"auto","fontSize":"12px","height":"32px"}' v-if="isAuth('qichexinxi','租赁汽车')" type="success" size="mini" @click="zulindingdanCrossAddOrUpdateHandler(scope.row,'cross','','zhuangtai','该汽车已租赁','已租赁,未租赁'.split(',')[0])">租赁汽车</el-button>
