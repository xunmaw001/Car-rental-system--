	...
	<view class="content">
		<view :style='{"width":"100%","padding":"0","position":"relative","background":"#EAF2FF","height":"auto"}'>
			<view class="cu-bar bg-white search" style="width:100%" :style="[{top:CustomBar + 'px'}]">
				<picker v-if="queryList.length>1" mode="selector" :range="queryList" range-key="queryName" :value="queryIndex" @change="queryChange" style="padding-left: 20upx;">
					...
					<view v-if="queryIndex==3" class="search-form round">
						<text class="cuIcon-search"></text>
						<input v-model="searchForm.yanse" type="text" placeholder="颜色" ></input>
					</view>
			...
			<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
				<scroll-view scroll-x="true" class="category-one" :style='{"width":"100%","padding":"10rpx","whiteSpace":"nowrap","background":"#efefef","display":"flex","height":"auto"}'>
					<view :class='categoryName === item.pinpai ? "active" : ""' class="tab" v-for="(item,index) in categoryList" :key="index" @tap="categoryClick(item.pinpai)">{{item.pinpai}}</view>
				</scroll-view>
			...
			<view class="list-box6" :style='{"padding":"24rpx","margin":"0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
				...
				<view @tap="onDetailTap(product)" v-if="index%6==0" class="list-item" :style='{"boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"0 0 20rpx","backgroundColor":"#fff","overflow":"hidden","borderRadius":"30rpx","width":"48%","height":"auto"}'>
				  ...
				  <view :style='{"padding":"4rpx 20rpx","margin":"10rpx 0 0 0","overflow":"hidden","color":"#333","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","height":"100rpx"}' class="title">品牌:{{product.pinpai}}</view>
				  <view :style='{"padding":"4rpx 20rpx","margin":"10rpx 0 0 0","overflow":"hidden","color":"#333","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","height":"100rpx"}' class="title">状态:{{product.zhuangtai}}</view>
				  <view :style='{"width":"100%","padding":"8rpx 20rpx","margin":"6rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('qichexinxi','修改')) || (!userid && isAuthFront('qichexinxi','修改'))" @click.stop="onUpdateTap(product.id)">
				  	...
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('qichexinxi','删除')) || (!userid && isAuthFront('qichexinxi','删除'))" @click.stop="onDeleteTap(product.id)">
				...
				<view @tap="onDetailTap(product)" v-if="index%6==3" class="list-item" :style='{"boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"0 0 20rpx","backgroundColor":"#fff","overflow":"hidden","borderRadius":"30rpx","width":"48%","height":"auto"}'>
				  ...
				  <view :style='{"padding":"4rpx 20rpx","overflow":"hidden","color":"#333","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","height":"100rpx"}' class="title">品牌:{{product.pinpai}}</view>
				  <view :style='{"padding":"4rpx 20rpx","overflow":"hidden","color":"#333","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","height":"100rpx"}' class="title">状态:{{product.zhuangtai}}</view>
				  <view :style='{"width":"100%","padding":"8rpx 20rpx","margin":"6rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('qichexinxi','修改')) || (!userid && isAuthFront('qichexinxi','修改'))" @click.stop="onUpdateTap(product.id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}' class="cuIcon-edit"></text>
				  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}'>修改</text>
				...
				<view @tap="onDetailTap(product)" v-if="index%6==4" class="list-item" :style='{"boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","padding":"10rpx 20rpx","margin":"0 0 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
				  ...
				  <view class="list-item-body" :style='{"width":"calc(100% - 200rpx)","padding":"0","margin":"0","overflow":"hidden","position":"relative","height":"200rpx"}'>
					...
					<view :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#333","width":"100%","lineHeight":"50rpx","fontSize":"28rpx","height":"50rpx"}' class="title">品牌:{{product.pinpai}}</view>
					<view :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#333","width":"100%","lineHeight":"50rpx","fontSize":"28rpx","height":"50rpx"}' class="title">状态:{{product.zhuangtai}}</view>
				  </view>
				  <view :style='{"width":"100%","padding":"8rpx 20rpx","margin":"6rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('qichexinxi','修改')) || (!userid && isAuthFront('qichexinxi','修改'))" @click.stop="onUpdateTap(product.id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}' class="cuIcon-edit"></text>
				...
				<view @tap="onDetailTap(product)" v-if="index%6==5" class="list-item" :style='{"boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","padding":"10rpx 20rpx","margin":"0 0 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
				  ...
				  <view class="list-item-body" :style='{"width":"calc(100% - 200rpx)","padding":"0","margin":"0","overflow":"hidden","position":"relative","height":"200rpx"}'>
					...
					<view :style='{"padding":"0 20rpx","margin":"0","color":"#333","width":"100%","lineHeight":"50rpx","fontSize":"28rpx","height":"50rpx"}' class="title">品牌:{{product.pinpai}}</view>
					<view :style='{"padding":"0 20rpx","margin":"0","color":"#333","width":"100%","lineHeight":"50rpx","fontSize":"28rpx","height":"50rpx"}' class="title">状态:{{product.zhuangtai}}</view>
				  </view>
				  <view :style='{"width":"100%","padding":"8rpx 20rpx","margin":"6rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('qichexinxi','修改')) || (!userid && isAuthFront('qichexinxi','修改'))" @click.stop="onUpdateTap(product.id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}' class="cuIcon-edit"></text>
...
<script>
	export default {
		...
		async onShow() {
            ...
            let res = {};
            if(this.userid) {
                res = await this.$api.page('cheliangpinpai', {page:1,limit:100});
            } else {
                res = await this.$api.list('cheliangpinpai', {page:1,limit:100});
            }
		...
		methods: {
			...
			async upCallback(mescroll) {
                ...
                let res = {}
                if(this.userid) {
                    res = await this.$api.page(`qichexinxi`, params);
                } else {
                    res = await this.$api.list(`qichexinxi`, params);
                }
				// 如果是第一页数据置空
			...
			async search(){
				...
				if(this.searchForm.yanse){
					searchForm['yanse'] = '%' + this.searchForm.yanse + '%'
				}
				if(this.searchForm.zhuangtai){
                ...
                let res = {};
                if(this.userid) {
                    res = await this.$api.page(`qichexinxi`, searchForm);
                } else {
                    res = await this.$api.list(`qichexinxi`, searchForm);
                }
				// 如果是第一页数据置空
