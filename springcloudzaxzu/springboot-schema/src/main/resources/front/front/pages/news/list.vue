		...
		<view :style='{"width":"100%","padding":"0","position":"relative","background":"#EAF2FF","height":"auto"}'>
			...
			<view :style='{"width":"100%","background":"#fff","height":"auto"}'>
				...
				<view class="news-box1" :style='{"width":"100%","padding":"24rpx","margin":"0","height":"auto"}'>
					<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","padding":"10rpx 20rpx","margin":"0 0 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
					  <view class="list-item-body" :style='{"width":"calc(100% - 200rpx)","padding":"0","margin":"0","height":"auto"}'>
						<view :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","height":"60rpx"}' class="title ">{{product.title}}</view>
						<view :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#666","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","height":"100rpx"}' class="desc ">{{product.introduction}}</view>
